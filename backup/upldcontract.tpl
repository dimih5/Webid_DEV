...
<link rel="stylesheet" href="{SITEURL}/themes/{THEME}/css/bootstrap.css">
<link rel="stylesheet" href="{SITEURL}/themes/{THEME}/css/bootstrap-responsive.css">
<!-- Bootstrap CSS fixes for IE6 -->
<!--[if lt IE 7]><link rel="stylesheet" href="http://blueimp.github.com/cdn/css/bootstrap-ie6.min.css"><![endif]-->
<link rel="stylesheet" href="{SITEURL}/assets/bootstrap-image-gallery/css/bootstrap-image-gallery.min.css">
...
<!-- <script src="{SITEURL}/assets/javascript-load-image/js/tmpl.min.js"></script> -->
<script src="{SITEURL}/assets/javascript-load-image/js/load-image.min.js"></script>
<script src="{SITEURL}/assets/javascript-canvas-to-blob/js/canvas-to-blob.min.js"></script>
<script src="{SITEURL}/themes/{THEME}/js/bootstrap.min.js"></script>
<script src="{SITEURL}/assets/blueimp-gallery/js/blueimp-gallery.min.js"></script>
<script src="{SITEURL}/assets/bootstrap-image-gallery/js/bootstrap-image-gallery.min.js"></script>
