...
<div class="control-group">
	<div>' . $MSG['757'] . ':</div> 
	<div> 
		<img id="siimage" src="' . $system->SETTINGS['siteurl'] . 'captcha.php?sid=' . md5(uniqid(time())) . '" /> 
		<a tabindex="-1"  href="' . $system->SETTINGS['siteurl'] . 'captcha_play.php" title="Audible Version of CAPTCHA"><img src="' . $system->SETTINGS['siteurl'] . 'includes/captcha/images/audio_icon.gif" alt="Audio Version" align="top" border="0" onclick="this.blur()" /></a><br /> 
		<a tabindex="-1"  href="#" title="Refresh Image" onclick="document.getElementById(\'siimage\').src = \'' . $system->SETTINGS['siteurl'] . 'captcha.php?sid=\' + Math.random(); return false"><img src="' . $system->SETTINGS['siteurl'] . 'includes/captcha/images/refresh.gif" alt="Reload Image" border="0" onclick="this.blur()" align="bottom" /></a>
	</div>
	<div></div>
	<div>' . $MSG['758'] . ':</div> 
	<div> 
