...
// Error messages =============================================================
$ERRMSG['001'] = "Database access error. Please contact the site administrator.";
$ERRMSG['002'] = "Name missing";
$ERRMSG['003'] = "Username missing";
$ERRMSG['004'] = "Password missing";
$ERRMSG['005'] = "Please, repeat your password";
$ERRMSG['006'] = "Passwords do not match";
$ERRMSG['007'] = "E-mail address missing";
$ERRMSG['008'] = "Please, insert a valid e-mail address";
$ERRMSG['009'] = "The username already exists in the database";
$ERRMSG['010'] = "Username too short (min 6 chars)";
$ERRMSG['011'] = "Password too short (min 6 chars)";
$ERRMSG['012'] = "Address missing";
$ERRMSG['013'] = "City missing";
$ERRMSG['014'] = "Country missing";
$ERRMSG['015'] = "ZIP/Post code missing";
$ERRMSG['016'] = "Please, insert a valid ZIP/Post code";
$ERRMSG['017'] = "Item's title missing";
$ERRMSG['018'] = "Item's description missing";
$ERRMSG['019'] = "Starting bid missing";
$ERRMSG['020'] = "Minimum quantity field is not correct";
$ERRMSG['021'] = "Reserve price missing";
$ERRMSG['022'] = "The reserve price you inserted is not correct";
$ERRMSG['023'] = "Choose a category for your item";
$ERRMSG['024'] = "Choose a payment method";
$ERRMSG['025'] = "Invalid user";
$ERRMSG['026'] = "Password incorrect";
$ERRMSG['027'] = "Currency symbol missing";
$ERRMSG['028'] = "Please, insert a valid e-mail address";
$ERRMSG['029'] = "User data are already registered";
$ERRMSG['030'] = "Fields must be numeric and in nnnn.nn format";
$ERRMSG['031'] = "The form you are submitting is not complete";
$ERRMSG['032'] = "One or both the e-mail addresses are not correct";
$ERRMSG['033'] = "Invalid confirmation link";
$ERRMSG['034'] = "Your bid must be at least: ";
$ERRMSG['035'] = "Days field must be numeric";
$ERRMSG['036'] = "The seller cannot bid in his/her own auctions";
$ERRMSG['037'] = "Search keyword cannot be empty";
$ERRMSG['038'] = "Login incorrect";
$ERRMSG['039'] = "You have already confirmed your registration.";
$ERRMSG['040'] = "You are the winning bidder and cannot place a bid lower than your previous maximum bid.";
$ERRMSG['041'] = "Please, choose a rate between 1 and 5";
$ERRMSG['042'] = "You comment is missing";
$ERRMSG['043'] = "Invalid field format: must be numeric";
$ERRMSG['044'] = "A user must be a member of atleast one group";
$ERRMSG['047'] = "Required fields missing";
$ERRMSG['048'] = "Incorrect login";
$ERRMSG['049'] = "The category's name cannot be empty";
$ERRMSG['050'] = "At least one group must have Auto Join enabled";
$ERRMSG['051'] = "Please, insert a valid number of digits";
$ERRMSG['054'] = "Please, fill in both the password fields";
$ERRMSG['055'] = "User <i>%s</i> already exists in the database";
$ERRMSG['056'] = "Bid increment value missing";
$ERRMSG['057'] = "Bid increment values must be numeric";
$ERRMSG['058'] = "Incorrect money format.";
$ERRMSG['059'] = "Your previous bid for this auction is higher than your current bid.<br>  In Dutch Auctions you may not place a bid if your previous <b>amount of bid times the quantity</b> is greater than your <b>amount of current bid times the quantity</b>.";
$ERRMSG['060'] = "The start date cannot be in the past.";
$ERRMSG['061'] = "The buy now price you inserted is not correct";
$ERRMSG['062'] = "You may not set a reserve price in a Dutch Auction";
$ERRMSG['063'] = "You may not use custom increment in a Dutch Auction";
$ERRMSG['064'] = "You may not use the Buy Now feature in a Dutch Auction";
$ERRMSG['065'] = "Error updating information";
$ERRMSG['066'] = "Error deleting information";
$ERRMSG['067'] = "Required fields missing (all fields are required).";
$ERRMSG['068'] = "Chosen theme does not exist";
$ERRMSG['069'] = "Currency conversion failed";
$ERRMSG['070'] = "This message doesn't exist";
$ERRMSG['071'] = "Username is invalid can only contain letters and numbers";
$ERRMSG['072'] = "You must enter a bid amount";
$ERRMSG['073'] = "You cannot bid on an auction that has not yet started";
$ERRMSG['074'] = "You have already left feedback on this transaction";
$ERRMSG['075'] = "No bids";
$ERRMSG['076'] = "Invalid Username/E-mail combination";
$ERRMSG['077'] = "Valid Token Expired";
$ERRMSG['078'] = "You must agree to the Terms and Conditions";

$ERRMSG['100'] = "User does not exist";
$ERRMSG['101'] = "Password incorrect";
$ERRMSG['102'] = "User does not exist";
$ERRMSG['103'] = "You cannot rate yourself";
$ERRMSG['104'] = "All fields required";
$ERRMSG['105'] = "Username does not exist";
$ERRMSG['106'] = "<br><br>No user specified";
$ERRMSG['107'] = "Username is too short";
$ERRMSG['108'] = "Password is too short";
$ERRMSG['109'] = "Passwords do not match";
$ERRMSG['110'] = "E-mail address incorrect";
$ERRMSG['_110'] = "Company name to short";
$ERRMSG['111'] = "Such a user already exists";
$ERRMSG['112'] = "Data missing";
$ERRMSG['113'] = "You must be at least 18 years old to register";
$ERRMSG['114'] = "No active auctions for this category";
$ERRMSG['115'] = "E-mail address already used";
$ERRMSG['117'] = "Invalid date of birth";
$ERRMSG['122'] = "No auction found";
$ERRMSG['600'] = 'Invalid auction type';
$ERRMSG['601'] = "Quantity field not correct";
$ERRMSG['602'] = "Images must be GIF, JPG or PNG";
$ERRMSG['603'] = "The image is too large.";
$ERRMSG['606'] = "Invalid auction";
...
$ERRMSG['612'] = "You cannot bid, you are the seller!";
$ERRMSG['614'] = "This auction is closed";
$ERRMSG['616'] = "Zip/Post code too short";
$ERRMSG['617'] = "Telephone number incorrect";
$ERRMSG['618'] = "Your account has been suspended by admin.";
$ERRMSG['619'] = "This auction has been suspended";
$ERRMSG['620'] = "Your account has yet to be activated please check your emails for the activation link.";
$ERRMSG['621'] = "Your account has yet to be activated by admin.";
$ERRMSG['622'] = "No such auction.";
$ERRMSG['623'] = "The auction you are trying to find either never existed or has been removed.";
$ERRMSG['624'] = "No message to post";
$ERRMSG['700'] = "Incorrect date format";
$ERRMSG['701'] = "Invalid quantity (must be >0).";
$ERRMSG['702'] = "Current Bid must be greater than minimum bid.";
$ERRMSG['704'] = "<br>You may not leave feedback about this user! <br>This auction is not closed!";
$ERRMSG['705'] = "You may only leave feedback, if you have a closed transaction with this user!";
$ERRMSG['706'] = "<i>Max. number of pictures</i> must be numeric.";
$ERRMSG['707'] = "<i>Max picture size</i> cannot be zero.";
$ERRMSG['708'] = "<i>Max picture size</i> must be numeric.";
$ERRMSG['709'] = "The picture you uploaded is too big. It cannot exceed ";
$ERRMSG['710'] = "Wrong file type. Allowed types are: GIF, PNG and JPEG";
$ERRMSG['711'] = "You cannot buy, you are the seller!";
$ERRMSG['712'] = "<b>Buy It Now</b> is not available for this auction";
$ERRMSG['713'] = "The value from must be less than the value to";
$ERRMSG['714'] = "The relist value must be numeric";
$ERRMSG['715'] = "You cannot choose to relist that many times";
$ERRMSG['5000'] = "Messages to show must be numeric";
$ERRMSG['5001'] = "Messages to show cannot be zero";
$ERRMSG['5002'] = "You must select at least one statistic type (accesses, browsers &amp; platforms, by country)";
$ERRMSG['5014'] = "Subject or message missing";
$ERRMSG['5029'] = "Name missing";
$ERRMSG['5030'] = "Username missing";
$ERRMSG['5031'] = "Password missing";
$ERRMSG['5032'] = "Please enter your password twice";
$ERRMSG['5033'] = "E-mail address missing";
$ERRMSG['5034'] = "Address missing";
$ERRMSG['5035'] = "City missing";
$ERRMSG['5036'] = "Province missing";
$ERRMSG['5037'] = "Country missing";
$ERRMSG['5038'] = "ZIP/Post code missing";
$ERRMSG['5039'] = "Telephone missing";
$ERRMSG['5040'] = "Birthdate missing or incomplete";
$ERRMSG['5045'] = "The reserve price cannot be less than the minimum bid";
$ERRMSG['5046'] = "The buy now price cannot be less than the minimum bid and/or the reserve price";
$ERRMSG['25_0001'] = "Please choose a sub-category";
$ERRMSG['25_0002'] = "<p>URL file-access is disabled on your server so WeBid is unable to run the version check</p>";
...
$MSG['CM_2026_0008'] = "Realtimeauction mod";
$MSG['CM_2026_0009'] = "Contract mod";
$MSG['CM_2026_0010'] = "Realtimeclock mod";
$MSG['CM_2026_0011'] = "Activate contracts mod";
$MSG['CM_2026_0012'] = "When you activate this options, bidders can upload contracts to their auction";
