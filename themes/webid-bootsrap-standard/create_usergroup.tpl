<div class="row">
    ...
    <div class="span9">
        <form action="{SITEURL}create_usergroup.php" method="post" id="create_usergroup">
            ...
            <button type="button" class="btn" onclick="javascript: submitform('create_usergroup')">Submit</button>
        </form>
    </div>
